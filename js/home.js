      ...
      data.forEach(photo => {
        ...
        photoBlock.innerHTML = `
          ...
          <div class="photo-block__overlay">
            <a class="photo-block__eye" href="${photo.link}" aria-label="Voir la photo">
            ...
            <button class="photo-block__fullscreen" type="button" data-full="${photo.image_full}" data-title="${photo.title.rendered}" data-reference="${photo.reference}" data-category="${photo.categorie}" aria-label="Afficher en plein écran">
